...
class SimpleModel(tf.keras.Model):
    ...
    def image_summary(x, name, num_images):
        ...
        image_format = tf.transpose(x, [3, 1, 2, 0])  # (128, 194, 194, None)
        image_format = image_format[0:num_images, :, :, 0]  # (1, 194, 194)
        image_format = tf.expand_dims(image_format, -1)  # (1, 194, 194, 1)
